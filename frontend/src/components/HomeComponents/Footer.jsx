...
function Footer() {
    return (
        <footer id="contact" className="bg-darkblack1">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-4 md:mb-0 w-auto md:max-w-[50%]">
                        <a href="#" className="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#FFFFFF" className="size-5 sm:size-6">
                                <path
                            ...
                            <span className="self-center text-3xl font-semibold whitespace-nowrap px-1 text-white">MealMatch</span>
                        </a>

                        <p className='w-auto text-gray-400 py-3 font-medium'>
                            Help bridge the hunger gap with every surplus plate.
                        </p>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                <li className="mb-2">
                                    <a href="https://github.com/Shivanshu0915" target="_blank" className="hover:underline ">Github</a>
                                </li>
                                <li>
                                    <a href="#" target="_blank" className="hover:underline">Discord</a>
                                </li>
                            </ul>
                        </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-md text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="#" className="hover:underline">MealMatch</a>.  All Rights Reserved.
                    </span>
                    <div className="flex mt-4 sm:justify-center sm:mt-0">
                        ...
                        <a href="https://github.com/Shivanshu0915" target="_blank" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
