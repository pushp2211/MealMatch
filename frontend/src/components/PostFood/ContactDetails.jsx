...
function ContactDetails(phone, email,handleChange) {
    return (

        <div className="bg-dashcard1 p-2 rounded-xl shadow-md space-y-4">
            <h2 className="text-lg font-semibold flex gap-x-1 items-center">
