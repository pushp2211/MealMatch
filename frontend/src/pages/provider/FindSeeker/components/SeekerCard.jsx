...
const SeekerCard = ({ seeker, etaMinutes, etaLoading, onClose }) => {
      ...
      <Card className="shadow-2xl border-t-4 border-t-primary bg-card/95 backdrop-blur-sm">
        <CardContent className="p-5 space-y-4">
          ...
          <div className="flex items-center justify-between text-sm py-2 border-y border-dashed">
            ...
            <div className="flex flex-col items-center px-4 border-r w-1/2">
              <span className="font-bold text-lg flex items-center gap-1">
                 {etaLoading ? "Calculating…" : etaMinutes ? `${etaMinutes} min` : "--"}
              </span>
